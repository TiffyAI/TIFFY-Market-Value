...
const pairAddress = '0x1305302Ef3929DD9252b051077e4ca182107F00D'; // TIFFY/WBNB V3
const pairABI = [
  {
    "constant": true,
    "inputs": [],
...
async function getBNBPriceUSD() {
  try {
    ...
    console.error('❌ Failed to fetch BNB price from CoinGecko:', e);
    return 0;
  }
}
...
async function main() {
  try {
    ...
    console.log('✅ price.json updated with live data:', priceData);
